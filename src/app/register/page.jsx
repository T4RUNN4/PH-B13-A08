...
export default function LoginPage() {
  ...
  return (
    <form className="hero mt-20 mb-10" onSubmit={handleSubmit(onSubmit)}>
      <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-2xl border p-4">
        ...
        <input type="text" className="input w-full" {...register("name", { required: true })} placeholder="Name" />
        {errors.name && <span className="text-red-400">This field is required</span>}

        <label className="label text-base">Photo</label>
        <input type="text" className="input w-full" {...register("photo", { required: true })} placeholder="url" />
        ...
        <button type="submit" className="btn btn-primary bg-red-500 text-white hover:bg-red-600 border-0 mt-8">
          Register
        </button>
